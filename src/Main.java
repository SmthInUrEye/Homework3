...
int productivity = 16/2, workTime = 0;
        System.out.println(
         "\n За " + (workTime = 20) + " часов машина произвела " + (productivity*workTime) +" штук бутылок" +
         "\n За " + (workTime = 24*60) + " часов машина произвела " + (productivity*workTime) +" штук бутылок" +
         "\n За " + (workTime = 24*3*60) + " часов машина произвела " + (productivity*workTime) +" штук бутылок" +
         "\n За " + (workTime = 24*30*60) + " часов машина произвела " + (productivity*workTime) +" штук бутылок" );
...
int targetWeigth = 7*1000, UpperLimitPerDay = 500, LowerLimitPerDay = 250;
        System.out.println("\n Количество необходимых дней если худеть по 250 грамм в день - " + targetWeigth/UpperLimitPerDay
         + "\n Количество необходимый дней если худеть по 500 грамм в день - " + targetWeigth/LowerLimitPerDay +
